...
<div class="container p-4 bg-white rounded shadow-sm">
    ...
    <hr>
    @can('admin')
        <a href="{{ route('node.create') }}" class="btn btn-primary mb-3">Input</a>
        <a href="{{ route('exportnode') }}" class="btn btn-success mb-3">Print</a>

        {{-- <form action="{{ route('importnode') }}" method="post" enctype="multipart/form-data">
